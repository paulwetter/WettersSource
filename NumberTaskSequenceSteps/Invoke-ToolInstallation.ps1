<#
.Synopsis
    Installs or uninstalls the Task Sequence Step Number console extension for ConfigMgr.
...
.NOTES
    Borrowed and tweaked this installer script from: https://www.scconfigmgr.com/2016/05/10/create-software-update-group-tool-console-extension-for-configmgr/
#>
...
param(
    ...
    [parameter(Mandatory=$true, HelpMessage="Specify a valid path to where the Task Sequence Step Number script file will be stored.")]
    [ValidateNotNullOrEmpty()]
...
Begin {
    ...
    $XMLFile = "NumberTsSteps.xml"
    $ScriptFile = "Set-TSStepNumbers.ps1"

    # Define node folders
    $Node = "f2c07bfb-d83d-4e0b-969b-5da6321c28c2"
